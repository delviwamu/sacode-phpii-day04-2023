...
<header class="border-2 m-5 p-5 shadow-md bg-white">
    <h1 class="text-3x1 font-bold text-gray-700 mb-3">Pendaftaran Kursus SaCode</h1>
...
<footer class="border-2 m-5 p-5 shadow-md bg-white">
    <p class="text-gray-500 text-xs">copyright &copy 2023, designed by <b>Delvi Wamu.</b></p>
</footer>
<!-- FOOTER END -->
